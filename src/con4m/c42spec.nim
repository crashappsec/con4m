...
proc buildC42Spec*(): ConfigSpec =
  ...
  rootSec.addAttr("gen_decl", boolType, false)
  ...
  singleton.addAttr("gen_decl", boolType, false)
  ...
  obj.addAttr("gen_decl", boolType, false)
