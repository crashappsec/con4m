...
proc cast_i_to_f(pre: pointer, tfrom, tto: TypeId, err: var string):
                pointer {.cdecl.} =
  let f = float64(cast[int64](pre))

  result = cast[pointer](f)

proc cast_u_to_f(pre: pointer, tfrom, tto: TypeId, err: var string):
                pointer {.cdecl.} =
...
boolOps[FMarshal]   = cast[pointer](marshal_64_bit_value_main)
boolOps[FUnmarshal] = cast[pointer](unmarshal_64_bit_value)
...
byteOps[FCastFn]    = cast[pointer](get_cast_func_u8)
byteOps[FMarshal]   = cast[pointer](marshal_64_bit_value_main)
byteOps[FUnmarshal] = cast[pointer](unmarshal_64_bit_value)
...
charOps[FMarshal]   = cast[pointer](marshal_64_bit_value_main)
charOps[FUnmarshal] = cast[pointer](unmarshal_64_bit_value)
...
i8Ops[FMarshal]     = cast[pointer](marshal_64_bit_value_main)
i8Ops[FUnmarshal]   = cast[pointer](unmarshal_64_bit_value)
...
i32Ops[FMarshal]    = cast[pointer](marshal_64_bit_value_main)
i32Ops[FUnmarshal]  = cast[pointer](unmarshal_64_bit_value)
...
u32Ops[FMarshal]    = cast[pointer](marshal_64_bit_value_main)
u32Ops[FUnmarshal]  = cast[pointer](unmarshal_64_bit_value)
...
i64Ops[FMarshal]    = cast[pointer](marshal_64_bit_value_main)
i64Ops[FUnmarshal]  = cast[pointer](unmarshal_64_bit_value)
...
u64Ops[FMarshal]    = cast[pointer](marshal_64_bit_value_main)
u64Ops[FUnmarshal]  = cast[pointer](unmarshal_64_bit_value)
